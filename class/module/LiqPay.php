...
class LiqPay
{
     ...
     * @throws InvalidArgumentException
     */
    public function cnb_form($params,$dashboard=false)
    {
        $language = 'ru';
        ...
        if ($dashboard) {
            ...
            <form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <input type="image" src="//static.liqpay.ua/buttons/p1%s.radius.png" name="btn_text" class="hidden_button js-liqpay-payment"/>
            </form>
            ',
                $this->_checkout_url,
            ...
            <form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <input type="image" src="//static.liqpay.ua/buttons/p1%s.radius.png" name="btn_text" class="js-liqpay-payment"/>
            </form>
            ',
                $this->_checkout_url,
                sprintf('<input type="hidden" name="%s" value="%s" />', 'data', $data),
