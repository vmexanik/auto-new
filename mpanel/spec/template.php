        ...
        if ($this->aSearch) {
            if (Language::getConstant('mpanel_search_strong', 0)) {
                ...
                if ($this->aSearch['type_'])
                    $this->sSearchSQL .= " and t.type_ = '" . $this->aSearch['type_'] . "'";
                if ($this->aSearch['code'])
                    $this->sSearchSQL .= " and t.code = '" . $this->aSearch['code'] . "'";
                if ($this->aSearch['priority'])
                    $this->sSearchSQL .= " and t.priority = '" . $this->aSearch['priority'] . "'";
                ...
                if ($this->aSearch['type_'])
                    $this->sSearchSQL .= " and t.type_ like '%" . $this->aSearch['type_'] . "%'";
                if ($this->aSearch['code'])
                    $this->sSearchSQL .= " and t.code like '%" . $this->aSearch['code'] . "%'";
                if ($this->aSearch['priority'])
                    $this->sSearchSQL .= " and t.priority like '%" . $this->aSearch['priority'] . "%'";
                if ($this->aSearch['content'])
