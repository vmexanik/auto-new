...
function SqlCatalogModelCall($aData) {
	...
	if (1) {
		$sJoin=" inner join cat_model as cm on ".DB_TOF."tof__models.mod_id=cm.tof_mod_id and cm.visible=1";
	}
		
	$sSql="select ifnull(lng_tex.tex_text, uni_tex.tex_text) as name,
         ".DB_TOF."tof__models.mod_id,   
         ".DB_TOF."tof__models.mod_id as id,   
         ".DB_TOF."tof__models.mod_pc,   
         ".DB_TOF."tof__models.mod_cv,
         mod_pcon_start,
         mod_pcon_end,
		 mod_mfa_id
		, substr(mod_pcon_start,5,2) as month_start, substr(mod_pcon_start,1,4) as year_start
		, substr(mod_pcon_end,5,2) as month_end, substr(mod_pcon_end,1,4) as year_end
