...
//#################################################################################
function check_auth() {
	if ($_SESSION["mmanager_auth".Base::$aGeneralConf['ProjectName']]) return true;
	return false;
}
//#################################################################################
function do_include($aTemp, $aFormValues = "", $aURL = "") {
	...
	include_once("manager_panel_action_array.php");
	...
	include_once(SERVER_PATH.'/include/manager_panel/manager_panel_includer.php');
