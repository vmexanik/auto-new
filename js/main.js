...
$(document).ready(function() {
    ...
    // VIA-65 скрытие сообщений после вывода на страницу
    setTimeout(function() {
...
$(function(){
    // plist thumbs height
    //$('.js-thumb-height .inner-wrap').matchHeight(); SHG-44 diff height
    ...
    //masked input
    $('.js-masked-input').mask("(099) 999 99 99");

		// if($(window).width() < 1000){
		// 	$('.js-masked-input').unmask();
