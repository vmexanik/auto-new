...
MstarVinRequest.prototype.AddRow = function (form)
{
	...
	if (a!=100) {
		...
		tr.cells[1].innerHTML="<input type=text name=\"azpDescript"+b+"\" maxlength=\"100\" style=\"width:100% !important; max-width: 145px;\" value=\"\">" +
				"<input type=text name=\"azpCnt"+b+"\" maxlength=\"2\" style=\"width:100% !important; max-width: 145px;\" value=\"1\">\n";
...
MstarVinRequest.prototype.AddManagerRow = function (form)
{
	...
	if (a!=100) {
		...
		tr.cells[4].innerHTML="<input type=text name='part["+b+"][number]' value='' style='width:50px;'>";
		tr.cells[5].innerHTML="<input type=text name='part["+b+"][weight]' value='' style='width:30px;'> kg";
