                            ...
                            if(!empty($parts['parts']['coord'])) {
                                foreach ($parts['parts']['coord'] as $key => $oneImageMap) {
                                    ...
                                    foreach ($oneImageMap as $map) {
                                        echo "<div class='map' onclick=\"scroll_to_part('{$map['name']}');\" data-part-number='map_{$map['name']}' style='margin-top:{$map['margin-top']}%; margin-left:{$map['margin-left']}%; position: absolute; width: {$map['width']}%; height: {$map['height']}%;'  onmouseout=\"map_disover('{$map['name']}')\"  onmouseover=\"map_over('{$map['name']}')\">";
