                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <? $a=array_keys($groups['model_info']);
				if(isset($groups['model_info'][$a[0]])):?>
                                <span class="vehicleinfolabel"><? echo $a[0];?>: </span>
                                <span class="vehicleinfolabeldata"><?echo $groups['model_info'][$a[0]];?></span>
                                <?endif;?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            echo "<td>
                                ...
                                if(isset($groups['model_info'][$a[1]])){
                                    echo "<td>
                                    <span class='vehicleinfolabel'>".$a[1].": </span>
                                    <span class='vehicleinfolabeldata'>{$groups['model_info'][$a[1]]}</span>
                                    </td>";
                                }
                                echo "</tr>";
                                if($count>2) {
                                    ...
                                    for ($i = 2; $i < $count; $i++) {
                                        echo "<td>";
                                        echo "<span class='vehicleinfolabel'>".$a[$i].": </span>";
                                        echo "<span class='vehicleinfolabeldata'>{$groups['model_info'][$a[$i]]}</span>";
                                        echo "</td>";
                                        if($i%2 != 0){
                                            if($rowCount<3) {
                                                echo "</tr><tr>";
                            ...
                            <tr>
                                <td colspan="2" class="addInfoTd">
                                    ...
                                    for ($i = $stoppedI; $i < $count; $i++) {
                                        echo "<b>".$a[$i].":</b> {$groups['model_info'][$a[$i]]}<br>";
                                    }
                                    echo "</span>";
                                    ?>
                                </td>
