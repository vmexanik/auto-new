...
<form class="navbar-form navbar-left">
	...
	<button type="button" class="btn btn-success"
		onclick="xajax_process_browse_url('/?action=manager_panel_edit_order_add_find&id={$id_cart_package}&code='+encodeURIComponent($('#data_code').val()))">
		{$oLanguage->getMessage('find')}
		</button>
	<button type="button" class="btn btn-default"
		onclick="xajax_process_browse_url('/?action=manager_panel_edit_order_add_optional&id={$id_cart_package}')">
