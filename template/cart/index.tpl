<div class="at-block-popup pages-cart-cart">
   <div class="block-popup" style="position: initial;">
...
<div class="at-basket-element">
   ...
   <div class="element-part data-part" style="width: 250px">
       <table class="at-list-basket-table">
           <tr>
               ...
               <td class="price-cell">
                   ...
                   <a href="/?action=cart_cart_delete&id={$aRow.id}" class="delete"></a>
               </td>
           </tr>
       </table>
   </div>
...
<div class="at-basket-element total">
   <table class="at-list-basket-table">
       <tr>
           ...
           <td class="price-cell">
               <div class="price-total" id="icart_total_id">{$oCurrency->PrintPrice($aSubtotalCart.dSubtotal)}</div>
           </td>
       </tr>
   </table>
   ...
   <div class="mob-settings-basket">
	...
	{if $aRow.number}
		<div class="basket-buttons">
		   <a href="/pages/cart_cart_clear" class="at-btn clear-btn" onclick="if (!confirm('{$oLanguage->getMessage("Are you sure you want to clar cart?")}')) return false;">Очистить корзину</a>
