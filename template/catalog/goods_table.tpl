...
{foreach key=key item=aValue from=$aColumn}
	...
	{if $key==$sTablePriceSort && $sTablePriceSortWay == 'up'}
		<a class="common-th" href="{$sSeoUrl}/sort={$sSort}/way=down">
	{elseif $key==$sTablePriceSort && $sTablePriceSortWay == 'down'}
		<a class="common-th" href="{$sSeoUrl}/sort={$sSort}/way=up">
	{else}
		<a class="common-th" href="{$sSeoUrl}/sort={$sSort}/way=up">
	{/if}
	{/if}
	...
	{else}
		...
		<div class="sorting-block">
			{if $key==$sTablePriceSort && $sTablePriceSortWay == 'up'}
				<a class="up" href="{$sSeoUrl}/sort={$sSort}/way=down"></a>
			{elseif $key==$sTablePriceSort && $sTablePriceSortWay == 'down'}
				<a class="down" href="{$sSeoUrl}/sort={$sSort}/way=up"></a>
			{else}
				<a class="up" href="{$sSeoUrl}/sort={$sSort}/way=up"></a>
				<a class="down" href="{$sSeoUrl}/sort={$sSort}/way=down"></a>
			{/if}
		</div>
	{/if}
	</th>
...
<tr id="tr{$iTr}" {if $bHideTr} pn="{$aItem[d].iHideTr}"{/if}
