	...
	<div class="col-md-7">
		<div class="card">
			<div class="card-header">
                <h3 class="card-title">{$oLanguage->getDMessage('Drop down additional')}</h3>
            </div>
...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			...
			<textarea name=data[page_description] class="form-control btn-sm">{$aData.page_description|escape}</textarea>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			...
			<input type=text name=data[page_keyword] value="{$aData.page_keyword|escape}" class="form-control btn-sm">
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			<label>{$oLanguage->getDMessage('Desription')}:</label>
