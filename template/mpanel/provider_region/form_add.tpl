	...
	<div class="col-md-7">
		<div class="card">
			<div class="card-header">
                <h3 class="card-title">{$oLanguage->getDMessage('Provider Region')}</h3>
            </div>
...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			<label>{$oLanguage->GetDMessage('CodeDelivery')}:{$sZir}</label>
...
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			<label>{$oLanguage->GetDMessage('Name_Provider')}:{$sZir}</label>
