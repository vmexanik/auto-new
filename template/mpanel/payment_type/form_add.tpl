	...
	<div class="col-md-7">
		<div class="card">
			<div class="card-header">
                <h3 class="card-title">{$oLanguage->getDMessage('payment Type')}</h3>
            </div>
	...
	<div class="col-sm">
	    <div class="form-group">
			<label>{$oLanguage->getDMessage('Description')}:</label>
   			{$oAdmin->getCKEditor('data[description]',$aData.description,700,400)}
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm">
	    <div class="form-group">
			<label>{$oLanguage->getDMessage('End Description')}:</label>
   			{$oAdmin->getCKEditor('data[end_description]',$aData.end_description,700,400)}
		</div>
	</div>
</div>
<div class="row">
