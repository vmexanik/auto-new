<?php /* Smarty version 2.6.18, created on 2019-09-25 12:23:17
         compiled from manager_panel/login.tpl */ ?>
<HTML>
<HEAD>
<TITLE><?php echo $this->_tpl_vars['sProjectName']; ?>
 mp v<?php echo $this->_tpl_vars['sManagerVersion']; ?>
 - ManagerPanel</TITLE>
...
<BODY>
	<?php echo $this->_tpl_vars['sTopMenu']; ?>

	<div id="message_javascript"></div>
	<div class="container theme-showcase" id="win_text"><?php echo $this->_tpl_vars['sText']; ?>
</div>
