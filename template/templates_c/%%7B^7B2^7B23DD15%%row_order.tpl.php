<?php /* Smarty version 2.6.18, created on 2019-09-25 12:40:09
         compiled from manager_panel/store/row_order.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager_panel/store/row_order.tpl', 5, false),array('modifier', 'in_array', 'manager_panel/store/row_order.tpl', 31, false),array('modifier', 'date_format', 'manager_panel/store/row_order.tpl', 70, false),)), $this); ?>
...
<td nowrap>
	<span class="glyphicon glyphicon-file" aria-hidden="true" style="font-size:14px;cursor:pointer"
		onclick="xajax_process_browse_url('/?action=manager_panel_store_view&id=<?php echo $this->_tpl_vars['aRow']['id']; ?>
