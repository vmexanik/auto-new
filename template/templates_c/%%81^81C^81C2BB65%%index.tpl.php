<?php /* Smarty version 2.6.18, created on 2019-09-25 12:40:00
         compiled from manager_panel/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manager_panel/index.tpl', 4, false),array('function', 'cycle', 'manager_panel/index.tpl', 151, false),)), $this); ?>
...
<thead>
<tr class="<?php echo $this->_tpl_vars['bCheckVisible']; ?>
">
	<?php if ($this->_tpl_vars['bCheckVisible']): ?><th <?php if ($this->_tpl_vars['bCheckAllVisible']): ?>style="white-space:nowrap;"<?php endif; ?>><?php if ($this->_tpl_vars['bCheckAllVisible']): ?><label><input type=checkbox class="<?php echo $this->_tpl_vars['sCheckAllClass']; ?>
" name=check_all
...
?>
	<?php echo '<th style="'; ?><?php if ($this->_tpl_vars['bHeaderNobr']): ?><?php echo 'white-space:nowrap;'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['aValue']['sWidth']): ?><?php echo 'width:'; ?><?php echo $this->_tpl_vars['aValue']['sWidth']; ?><?php echo ''; ?><?php endif; ?><?php echo '" '; ?><?php if ($this->_tpl_vars['aValue']['sHeaderClassSelect']): ?><?php echo 'class="'; ?><?php echo $this->_tpl_vars['aValue']['sHeaderClassSelect']; ?><?php echo '"'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['aValue']['sClass']): ?><?php echo ' class="'; ?><?php echo $this->_tpl_vars['aValue']['sClass']; ?><?php echo '"'; ?><?php endif; ?><?php echo ''; ?><?php echo $this->_tpl_vars['aValue']['sAdditionalHtml']; ?><?php echo '>'; ?><?php $this->assign('sSort', $this->_tpl_vars['key']); ?><?php echo ''; ?><?php if ($this->_tpl_vars['aValue']['sOrderLink']): ?><?php echo '<a href=\''; ?><?php if (! $this->_tpl_vars['bNoneDotUrl']): ?><?php echo '.'; ?><?php endif; ?><?php echo '/?'; ?><?php echo $this->_tpl_vars['aValue']['sOrderLink']; ?><?php echo '\' '; ?><?php echo $this->_tpl_vars['title_order_link']; ?><?php echo '>'; ?><?php endif; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['aValue']['nosort']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['sTablePriceSort'] && $this->_tpl_vars['sTablePriceSortWay'] == 'up'): ?><?php echo '<div class="th-inner sortable both asc"><a class="common-th" href="'; ?><?php echo $this->_tpl_vars['sSeoUrl']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'sort='; ?><?php echo $this->_tpl_vars['sSort']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'way=down"onclick=" xajax_process_browse_url(this.href); return false;">'; ?><?php elseif ($this->_tpl_vars['key'] == $this->_tpl_vars['sTablePriceSort'] && $this->_tpl_vars['sTablePriceSortWay'] == 'down'): ?><?php echo '<div class="th-inner sortable both desc"><a class="common-th" href="'; ?><?php echo $this->_tpl_vars['sSeoUrl']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'sort='; ?><?php echo $this->_tpl_vars['sSort']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'way=up"onclick=" xajax_process_browse_url(this.href); return false;">'; ?><?php else: ?><?php echo '<div class="th-inner sortable both"><a class="common-th" href="'; ?><?php echo $this->_tpl_vars['sSeoUrl']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'sort='; ?><?php echo $this->_tpl_vars['sSort']; ?><?php echo '&'; ?><?php echo $this->_tpl_vars['sType']; ?><?php echo 'way=up"onclick=" xajax_process_browse_url(this.href); return false;">'; ?><?php endif; ?><?php echo ''; ?><?php echo $this->_tpl_vars['aValue']['sTitle']; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['aValue']['sTitle']): ?><?php echo '&nbsp;'; ?><?php endif; ?><?php echo '</a>'; ?><?php else: ?><?php echo '<div class="th-inner">'; ?><?php echo $this->_tpl_vars['aValue']['sTitle']; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['aValue']['sTitle']): ?><?php echo '&nbsp;'; ?><?php endif; ?><?php echo '</div>'; ?><?php endif; ?><?php echo '<div class="fht-cell"></div>'; ?><?php if ($this->_tpl_vars['aValue']['sOrderLink']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['aValue']['sOrderImage']): ?><?php echo '<img src=\''; ?><?php echo $this->_tpl_vars['aValue']['sOrderImage']; ?><?php echo '\' style="margin-right:1px;margin-left:1px;">'; ?><?php endif; ?><?php echo '</a>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['aValue']['sHint']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['oLanguage']->GetContextHint($this->_tpl_vars['aValue']['sHint']); ?><?php echo ''; ?><?php endif; ?><?php echo '</th>'; ?>

<?php endforeach; endif; unset($_from); ?>
	<?php if ($this->_tpl_vars['bCheckRightVisible']): ?><th style="<?php if ($this->_tpl_vars['bCheckAllVisible']): ?>white-space:nowrap;<?php endif; ?>"><?php if ($this->_tpl_vars['bCheckAllVisible']): ?><label><input type=checkbox name=check_all class="<?php echo $this->_tpl_vars['sCheckAllClass']; ?>
" 
		onclick="mt.SetCheckboxes(this.form,this.checked);<?php if ($this->_tpl_vars['sCheckAllAction'] != ''): ?><?php echo $this->_tpl_vars['sCheckAllAction']; ?>
;<?php endif; ?>"
		 <?php if ($this->_tpl_vars['bDefaultChecked']): ?>checked<?php endif; ?> ><?php endif; ?><?php if ($this->_tpl_vars['sMarkAllText']): ?>&nbsp;<?php echo $this->_tpl_vars['sMarkAllText']; ?>
...
<tr>
	<?php if ($this->_tpl_vars['bCheckVisible']): ?><th style="<?php if ($this->_tpl_vars['bCheckAllVisible']): ?>white-space:nowrap;<?php endif; ?>"><?php if ($this->_tpl_vars['bCheckAllVisible']): ?><label><input type=checkbox name=check_all class="<?php echo $this->_tpl_vars['sCheckAllClass']; ?>
"
		onclick="mt.SetCheckboxes(this.form,this.checked);<?php if ($this->_tpl_vars['sCheckAllAction'] != ''): ?><?php echo $this->_tpl_vars['sCheckAllAction']; ?>
;<?php endif; ?>"
		 <?php if ($this->_tpl_vars['bDefaultChecked']): ?>checked<?php endif; ?> ><?php endif; ?><?php if ($this->_tpl_vars['sMarkAllText']): ?>&nbsp;<?php echo $this->_tpl_vars['sMarkAllText']; ?>
...
?>
	...
	<th style="white-space:nowrap;<?php if ($this->_tpl_vars['aValue']['sWidth']): ?>width:<?php echo $this->_tpl_vars['aValue']['sWidth']; ?>
...
"<?php endif; ?>
	<?php if ($this->_tpl_vars['aItem'][$this->_sections['d']['index']]['tr_tooltip']): ?>
		<?php $_from = $this->_tpl_vars['aItem'][$this->_sections['d']['index']]['tr_tooltip']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['Tkey'] => $this->_tpl_vars['TValue']):
?>
			<?php echo $this->_tpl_vars['Tkey']; ?>
="<?php echo $this->_tpl_vars['TValue']; ?>
"
		<?php endforeach; endif; unset($_from); ?>
	<?php endif; ?>
...
<?php endif; ?>>
	...
	<?php if ($this->_tpl_vars['bCheckVisible']): ?><td><div class="form-check"><?php if (! $this->_tpl_vars['aRow']['bCheckHide']): ?><label><input type=checkbox name=row_check[] class="form-check-input"
...
"<?php endif; ?>><?php endif; ?></label></div></td>
	<?php endif; ?>
