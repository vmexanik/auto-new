<?php /* Smarty version 2.6.18, created on 2020-07-27 10:43:03
         compiled from form/main_search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strpos', 'form/main_search.tpl', 52, false),)), $this); ?>
<div class="form_body">
...
<div class="js-form-content" <?php if (! $_REQUEST['search']): ?>style="display: none;"<?php endif; ?>>
...
')) return false;"
    	<?php else: ?>
            <?php if (((is_array($_tmp=$this->_tpl_vars['sHeader'])) ? $this->_run_mod_handler('strpos', true, $_tmp, 'id_order_report_form') : strpos($_tmp, 'id_order_report_form'))): ?>onclick="change_form_action('id_order_report_form','<?php echo $this->_tpl_vars['sSubmitAction']; ?>
');"<?php endif; ?>
        <?php endif; ?>
    	 >
    <?php endif; ?>
